...
<div>
    <h3> Search Keyword Statistics <span style="color: gray;">2.3</span> </h3>
    ...
    <div>
        ...
        <div style="margin: 5px 0 25px 0;">
            ...
            <form name="frmClear" id="frmClear" action="" method="post" onsubmit="javascript:return clearDta();">

                <input type="checkbox" name="clear" id="clear" /> To clear all data.  &nbsp; <input type="submit" name="ss_search_submit_clear" value="Clear" class="ss_search_submit"/>
            </form>
    ...
    <div>
        ...
        <div style="outline: 2px ridge #1B121C; margin:10px 10px; text-align:center; font-size:14px; font-family:Georgia, 'Times New Roman', Times, serif; padding:2px 2px; float:left;">
            <h4>Recent Posts from Our Knowledge n Power </h4>
            ...
            <div>
                ...
                <script>(function(d, s, id) {
                        ...
                        js = d.createElement(s);
                        js.id = id;
                        js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=337021913129898";
                        fjs.parentNode.insertBefore(js, fjs);
                    }(document, 'script', 'facebook-jssdk'));</script>
                <div class="fb-page" data-href="https://www.facebook.com/knowledgenpowerin" data-width="500" data-small-header="false" data-adapt-container-width="false" data-hide-cover="false" data-show-facepile="true" data-show-posts="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/knowledgenpowerin"><a href="https://www.facebook.com/knowledgenpowerin">Knowledge and Power</a></blockquote></div></div>
            </div>
